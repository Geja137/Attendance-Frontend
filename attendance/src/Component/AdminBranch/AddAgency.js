...
function AddAgency() {
  ...
  const agencyOptions = ["Catering", "Sanitary", "Transport", "Security", "Maintenance", "Other"];
  ...
  const handleSubmit = (e) => {
    ...
    const agencyData = {
      agencyName: e.target.agencyName.value,
      contact: e.target.contact.value,
      email: e.target.email.value,
      types: finalTypes,
    };

    console.log("Submitted Agency Data:", agencyData);
    navigate("/admin-login/card");
  };
